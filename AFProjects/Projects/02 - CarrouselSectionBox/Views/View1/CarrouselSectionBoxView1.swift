//
//  CarrouselSectionBoxView1.swift
//  AFProjects
//
...
public class CarrouselSectionBoxView1: UIView {

    @IBOutlet public weak var contentView: UIView!
    @IBOutlet public weak var titleLabel: UILabel!
    @IBOutlet public weak var ibanLabel: UILabel!
    
    public var accessibilityTotalLabel: String = ""
    ...
    fileprivate func loadViewFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "CarrouselSectionBoxView1", bundle: bundle)
        let view = nib.instantiate(withOwner: self, options: nil).first as? UIView
        return view ?? UIView()
    }

    public func setupView(title: String, iban: String) {
